  ...
  return (
    <div className="py-10 md:py-20 flex flex-col justify-center gap-8 mx-auto max-w-7xl px-5">
      <div className=" flex items-center gap-3 justify-center">
        <span className=" flex md:hidden"> <LibraryBigIcon size={30} /></span>
        <span className=" hidden md:flex"> <LibraryBigIcon size={40} /></span>
        <h1 className=" font-bold text-2xl md:text-4xl">Syllabus</h1>
      </div>
