  ...
  return (
    <div className=" grid grid-cols-1 md:grid-cols-3 gap-5 py-5 md:py-12 ">
      ...
      <div className=" grid md:col-span-2 gap-5">
        ...
        <p className=" text-base md:hidden">By eliminating the need for constant group messaging, our app frees up your time so you can focus on what really matters: your studies. Stay organized and up-to-date with all your academic information at your fingertips.</p>
      </div>
